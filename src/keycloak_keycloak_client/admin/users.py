...
class Users(KeycloakAdminBase):
    ...
    def create(self, username, **kwargs):
        ...
        for key in USER_KWARGS:
            from python_keycloak_client.admin.clientroles import to_camel_case
...
class User(KeycloakAdminBase):
    ...
    def role_mappings(self):
        from python_keycloak_client.admin.user.userroles import UserRoleMappings
    ...
    @property
    def groups(self):
        from python_keycloak_client.admin.user.usergroup import UserGroups
